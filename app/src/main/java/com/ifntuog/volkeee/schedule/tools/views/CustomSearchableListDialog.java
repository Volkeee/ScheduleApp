...
public class CustomSearchableListDialog extends DialogFragment implements
    ...
    public CustomSearchableListDialog() {

    }

    public static CustomSearchableListDialog newInstance(ArrayList<Group> items) {
        CustomSearchableListDialog multiSelectExpandableFragment = new
                CustomSearchableListDialog();
    ...
    private void setData(View rootView) {
        ...
        ArrayList<Group> groups = (ArrayList<Group>) getArguments().getSerializable(ITEMS);
//        List items = (List) getArguments().getSerializable(ITEMS);

        _listViewItems = rootView.findViewById(R.id.listItems);
        //create the adapter by passing your ArrayList data
        listAdapter = new SearchableSpinnerAdapter(getActivity(), android.R.layout.simple_list_item_1,
                groups);
